# Program to generate the sounds of notes of a Iberian scale matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1, notescale):
    ...
    # Interval of notes for a Iberian scale
    notes_interval = [1, 3, 1, 2, 3, 2, 2] #1 - 3 - 1 - 2 - 3 - 2
    ...
    # Return list of frequencies in the ascending and descending notes of the Iberian scale    
...
# Scale list for which the Iberian scale will be played in sequence
scale_list = ['C4']
